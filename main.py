...
# Función mostar puntaje
def mostrar_puntaje(x, y):
    texto = fuente.render(f"Puntaje: {puntaje}", True, (255, 255, 255))
    pantalla.blit(texto, (x, y))


# Función para posicionar al jugador en la pantalla
def jugador(x, y):
    pantalla.blit(img_jugador, (x, y))


# Función para posicionar al enemigo en la pantalla
def enemigo(x, y, ene):
...
while se_ejecuta:
    ...
    for evento in pygame.event.get():
        ...
        # evento para comprobar si el usuario a soltado la tecla izquierda y derecha
